...
import { Folder, Calendar, ArrowLeft, Pin } from 'lucide-react'
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[900px] px-4 pb-12 pt-24 lg:px-6">
        <Link href="/categories" className="mb-6 inline-flex items-center gap-1 text-sm text-muted-foreground transition-colors hover:text-primary">
          <ArrowLeft className="size-4" /> 返回分类列表
        </Link>
